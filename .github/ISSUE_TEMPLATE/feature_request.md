...
description: Suggest an idea for future development of our theme
title: '[FEAT] <title>'
  ...
  - type: markdown
    attributes:
      value: |-
        ...
        If you haven't already done so, please Star the WhiteSurFirefoxThemeMacOS's repository on GitHub, to help other users discover it
    validations:
      required: false
---
